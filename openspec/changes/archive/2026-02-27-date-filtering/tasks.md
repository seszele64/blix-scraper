...
**Acceptance Criteria**:
- [x] dateparser installed successfully
- [x] Can import in Python
...
**Acceptance Criteria**:
- [x] DateFilterOptions model created
- [x] has_date_filter() works correctly
- [x] to_predicate() returns callable predicate
...
**Acceptance Criteria**:
- [x] Method returns True for overlapping range
- [x] Method returns False for non-overlapping range
...
**Acceptance Criteria**:
- [x] is_valid_on works correctly
- [x] is_valid_in_range works correctly
...
**Acceptance Criteria**:
- [x] All domain date methods tested
- [x] Coverage > 70% for domain/date_filter.py
...
**Acceptance Criteria**:
- [x] ISO dates parse correctly
- [x] Natural language dates parse correctly
- [x] Range parsing works
- [x] Invalid dates raise DateParseError
...
**Acceptance Criteria**:
- [x] Extends existing JSONStorage
- [x] load_all applies date filter
...
**Acceptance Criteria**:
- [x] All date options work
- [x] Natural language dates parse
...
**Acceptance Criteria**:
- [x] Date filtering works with search
- [x] Results filtered by leaflet validity
...
**Acceptance Criteria**:
- [x] CLI commands work with filters
...
- [x] Results are correctly filtered
- [x] Error messages are helpful
...
### Implementation
- [x] Phase 1 complete (dependency)
- [x] Phase 2 complete (domain)
- [x] Phase 3 complete (date parser)
- [x] Phase 4 complete (storage)
- [x] Phase 5 complete (CLI)

### Post-Implementation
- [x] Phase 6 complete (testing)
- [x] All tests pass
- [x] Coverage > 70%
- [x] mypy passes
- [x] Linting passes
